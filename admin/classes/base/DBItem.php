		...
		class DBItem
		{
			...
			*/
			...
			public function Upload()
			{
				...
				self::$DB->QuerySingle("INSERT INTO ".self::GetTableFromClass(get_called_class())." SET ".$Fields, $NewData);
