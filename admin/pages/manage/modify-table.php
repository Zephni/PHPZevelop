...
<script type="text/javascript">
	$(document).ready(function(){
		...
		FieldHTML += "<select type='text' name='field_type[]' style='width: 24%; margin-right: 1.3%;'><option>VARCHAR(255)</option><option>TEXT</option></select>";
		...
		<?php
			foreach($Table["columns"] as $K => $V)
			{
				...
				LoadedFieldHTML += "<input type='hidden' name='original_field_name[]' style='width: 24%; margin-right: 1.3%;' value='<?php echo $K; ?>' />";
				LoadedFieldHTML += "<input type='text' name='field_name[]' style='width: 24%; margin-right: 1.3%;' placeholder='field name' value='<?php echo $K; ?>' />";

				LoadedFieldHTML += "<select type='text' name='field_type[]' style='width: 24%; margin-right: 1.3%;'><option>VARCHAR(255)</option><option>TEXT</option></select>";

				LoadedFieldHTML += "<input type='hidden' name='original_field_default[]' style='width: 24%; margin-right: 1.3%;' value='<?php echo $V["column_default"]; ?>' />";
				LoadedFieldHTML += "<input type='text' name='field_default[]' style='width: 24%; margin-right: 1.2%;' placeholder='field default' value='<?php echo $V["column_default"]; ?>' />";

				LoadedFieldHTML += "<input type='hidden' name='original_field_comment[]' style='width: 24%;' value='<?php echo $V["column_comment"]; ?>' />";
				LoadedFieldHTML += "<input type='text' name='field_comment[]' style='width: 24%;' placeholder='field comment' value='<?php echo $V["column_comment"]; ?>' />";
