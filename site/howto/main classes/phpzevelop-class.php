...
A property can by overwritten by applying a new object to the same string value. An example of why you may do this can be found <a href="#PathClass">here</a>.</p>
...
<p>see more here: <a href="#MetaData">Meta data</a>.</p>
