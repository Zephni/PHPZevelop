...
<h4>Option 1 (Default): No pages accept parameters unless specified</h4>
...
<p>.. to the OverrideObjectData array at the top of the page. To see this in action have a look <a href="#UrlData">here</a>. In Url data
PassParams has been set to true in the configuration instance, so any parameters passed will be accessible on that page.</p>


<br /><h4>Option 2: All pages accept parameters unless specified</h4>
...
if you were to put "/help/test/value1/value2" that page would be able to access them variables (as explained <a href="#UrlData">here</a>).</p>
...
<p>You can specify a 404 page to fall back on if PassParams is turned off and the page passed does not exist, for more information check here: <a href="#Configuration">configuration</a>.</p>