...
<p>.. to the top of the PHP page below the Meta data. To see this in action have a look <a href="<?php $PHPZevelop->Path->GetPage("example/vars/5/test"); ?>" target="_blank">here</a>. In "example/vars.php"
...
<p>To explain what this does.. say you have a page located at "/example/test.php" which can be accessed by simply using "/example/test" as a URL, 
